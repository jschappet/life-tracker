...
#[get("/api/tasks")]
pub async fn get_tasks_api(data: web::Data<AppState>) -> impl Responder {
...
pub async fn delete_task_api(data: web::Data<AppState>, task_id: web::Path<i32>) -> impl Responder {
    let conn = &mut data.db_pool.get().expect("Database connection failed");
